...
class Semester4CSE extends StatefulWidget {
  const Semester4CSE({super.key});

  @override
  State<Semester4CSE> createState() => _Semester4CSEState();
}

class _Semester4CSEState extends State<Semester4CSE> {
  ...
  final credits = [3,3,4,3,4,3,1,1,1,1];
  double sgpa = 0.0;
