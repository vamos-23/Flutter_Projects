...
class Semester6CSE extends StatefulWidget {
  const Semester6CSE({super.key});

  @override
  State<Semester6CSE> createState() => _Semester6CSEState();
}

class _Semester6CSEState extends State<Semester6CSE> {
  ...
  final credits = [3,4,3,3,3,3,1,2,2];
  double sgpa = 0.0;
