...
class Semester3CSSE extends StatefulWidget {
  const Semester3CSSE({super.key});

  @override
  State<Semester3CSSE> createState() => _Semester3CSSEState();
}

class _Semester3CSSEState extends State<Semester3CSSE> {
  ...
  final credits = [4,3,3,4,4,2,1,1,1];
  double sgpa = 0.0;
