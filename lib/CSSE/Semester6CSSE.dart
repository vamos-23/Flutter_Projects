...
class Semester6CSSE extends StatefulWidget {
  const Semester6CSSE({super.key});

  @override
  State<Semester6CSSE> createState() => _Semester6CSSEState();
}

class _Semester6CSSEState extends State<Semester6CSSE> {
  var grades = ['Select Grade', 'O', 'E', 'A', 'B', 'C', 'D', 'F'];
  var subjects = [
    'HASS Elective - 3',
    'Compilers',
    'ARM & Advanced Microprocessors',
    'Professional Elective - 3',
    'Open-Elective - 2/ MI - 1',
  ...
  final credits = [3,3,3,3,3,3,1,2,2];
  double sgpa = 0.0;
