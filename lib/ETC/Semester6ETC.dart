...
class Semester6ETC extends StatefulWidget {
  const Semester6ETC({super.key});

  @override
  State<Semester6ETC> createState() => _Semester6ETCState();
}

class _Semester6ETCState extends State<Semester6ETC> {
  ...
  final credits = [3,3,3,3,3,3,1,1,2,2];
  double sgpa = 0.0;
