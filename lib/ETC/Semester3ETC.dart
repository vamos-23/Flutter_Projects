...
class Semester3ETC extends StatefulWidget {
  const Semester3ETC({super.key});

  @override
  State<Semester3ETC> createState() => _Semester3ETCState();
}

class _Semester3ETCState extends State<Semester3ETC> {
  ...
  final credits = [4,3,3,3,4,2,2,1,1];
  double sgpa = 0.0;
