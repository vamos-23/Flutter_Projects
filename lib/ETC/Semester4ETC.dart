...
class Semester4ETC extends StatefulWidget {
  const Semester4ETC({super.key});

  @override
  State<Semester4ETC> createState() => _Semester4ETCState();
}

class _Semester4ETCState extends State<Semester4ETC> {
  var grades = ['Select Grade', 'O', 'E', 'A', 'B', 'C', 'D', 'F'];
  var subjects = [
    'Vectors, Diff. Eqns. and CA',
  ...
  final credits = [4,3,4,3,2,3,1,1,1];
  double sgpa = 0.0;
