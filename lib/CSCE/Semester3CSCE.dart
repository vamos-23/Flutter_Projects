...
class Semester3CSCE extends StatefulWidget {
  const Semester3CSCE({super.key});

  @override
  State<Semester3CSCE> createState() => _Semester3CSCEState();
}

class _Semester3CSCEState extends State<Semester3CSCE> {
  ...
  final credits = [4,2,3,3,4,2,1,1,1];
  double sgpa = 0.0;
