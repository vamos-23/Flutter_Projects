...
class Semester4CSCE extends StatefulWidget {
  const Semester4CSCE({super.key});

  @override
  State<Semester4CSCE> createState() => _Semester4CSCEState();
}

class _Semester4CSCEState extends State<Semester4CSCE> {
  ...
  final credits = [3,3,4,3,3,3,1,1,1,1];
  double sgpa = 0.0;
