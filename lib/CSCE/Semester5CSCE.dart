...
class Semester5CSCE extends StatefulWidget {
  const Semester5CSCE({super.key});

  @override
  State<Semester5CSCE> createState() => _Semester5CSCEState();
}

class _Semester5CSCEState extends State<Semester5CSCE> {
  ...
  final credits = [3,3,4,3,3,3,1,1,1];
  double sgpa = 0.0;
