...
class Semester3EEE extends StatefulWidget {
  const Semester3EEE({super.key});

  @override
  State<Semester3EEE> createState() => _Semester3EEEState();
}

class _Semester3EEEState extends State<Semester3EEE> {
  ...
  final credits = [4,3,4,3,3,2,2,1,1];
  double sgpa = 0.0;
