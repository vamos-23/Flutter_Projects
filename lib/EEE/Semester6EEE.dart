...
class Semester6EEE extends StatefulWidget {
  const Semester6EEE({super.key});

  @override
  State<Semester6EEE> createState() => _Semester6EEEState();
}

class _Semester6EEEState extends State<Semester6EEE> {
  ...
  final credits = [3,3,3,3,3,3,2,1,1,2];
  double sgpa = 0.0;
