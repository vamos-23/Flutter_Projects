...
class Semester6ME extends StatefulWidget {
  const Semester6ME({super.key});

  @override
  State<Semester6ME> createState() => _Semester6MEState();
}

class _Semester6MEState extends State<Semester6ME> {
  var grades = ['Select Grade', 'O', 'E', 'A', 'B', 'C', 'D', 'F'];
  var subjects = [
    'Universal Human Values',
    'Applied Thermal Engineering',
    'Engineering Metrology and Control',
  ...
  final credits = [3,4,3,3,3,3,1,1,1,2];
  double sgpa = 0.0;
