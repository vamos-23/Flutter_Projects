...
class Semester5ME extends StatefulWidget {
  const Semester5ME({super.key});

  @override
  State<Semester5ME> createState() => _Semester5MEState();
}

class _Semester5MEState extends State<Semester5ME> {
  ...
  var subjects = [
    ...
    'Heat Transfer',
    'Industrial Engineering & Ops Research',
  ...
  final credits = [3,3,3,3,3,3,1,1,1,1];
  double sgpa = 0.0;
