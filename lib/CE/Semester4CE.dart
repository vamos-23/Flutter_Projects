...
class Semester4CE extends StatefulWidget {
  const Semester4CE({super.key});

  @override
  State<Semester4CE> createState() => _Semester4CEState();
}

class _Semester4CEState extends State<Semester4CE> {
  var grades = ['Select Grade', 'O', 'E', 'A', 'B', 'C', 'D', 'F'];
  var subjects = [
    'HASS Elective - 2',
    'Vectors, PDEs & Complex Analysis',
  ...
  final credits = [3,4,4,4,3,2,1,1,1,1];
  double sgpa = 0.0;
