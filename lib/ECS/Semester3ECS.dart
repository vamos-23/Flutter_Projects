...
class Semester3ECS extends StatefulWidget {
  const Semester3ECS({super.key});

  @override
  State<Semester3ECS> createState() => _Semester3ECSState();
}

class _Semester3ECSState extends State<Semester3ECS> {
  ...
  final credits = [4,4,4,3,3,2,1,1,1];
  double sgpa = 0.0;
