...
class Semester6ECS extends StatefulWidget {
  const Semester6ECS({super.key});

  @override
  State<Semester6ECS> createState() => _Semester6ECSState();
}

class _Semester6ECSState extends State<Semester6ECS> {
  ...
  final credits = [4,3,3,3,3,3,2,1,1,1];
  double sgpa = 0.0;
