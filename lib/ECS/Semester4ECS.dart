...
class Semester4ECS extends StatefulWidget {
  const Semester4ECS({super.key});

  @override
  State<Semester4ECS> createState() => _Semester4ECSState();
}

class _Semester4ECSState extends State<Semester4ECS> {
  ...
  final credits = [4,3,3,3,2,3,1,2,2];
  double sgpa = 0.0;
