...
class Semester5ECS extends StatefulWidget {
  const Semester5ECS({super.key});

  @override
  State<Semester5ECS> createState() => _Semester5ECSState();
}

class _Semester5ECSState extends State<Semester5ECS> {
  ...
  final credits = [3,3,3,3,3,3,1,1,1,1,1];
  double sgpa = 0.0;
