...
import 'package:kiit_cgpa_calculator/CSCE/Semester5CSCE.dart';
import '../CSCE/Semester3CSCE.dart';
import '../CSCE/Semester4CSCE.dart';
import '../CSCE/Semester6CSCE.dart';
import '../Semester1.dart';
import '../Semester2.dart';

class CSCEPage extends StatefulWidget {
  const CSCEPage({super.key});
  @override
  State<CSCEPage> createState() => CSCEPageState();
}

class CSCEPageState extends State<CSCEPage> {
  ...
  Widget getSemesterContent(String semester,Size screenSize) {
    ...
    switch (semester) {
      ...
      case 'Semester 2 (A/B)':
        return Semester2();
      case 'Semester 3':
        return Semester3CSCE();
      case 'Semester 4':
        return Semester4CSCE();
      case 'Semester 5':
        return Semester5CSCE();
      case 'Semester 6':
        return Semester6CSCE();
      default:
    return Center(
      child: Padding(
