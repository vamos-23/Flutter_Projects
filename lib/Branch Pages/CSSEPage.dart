...
import '../CSSE/Semester3CSSE.dart';
import '../CSSE/Semester4CSSE.dart';
import '../CSSE/Semester5CSSE.dart';
import '../CSSE/Semester6CSSE.dart';
import '../Semester1.dart';
import '../Semester2.dart';

class CSSEPage extends StatefulWidget {
  const CSSEPage({super.key});
  @override
  State<CSSEPage> createState() => CSSEPageState();
}

class CSSEPageState extends State<CSSEPage> {
  ...
  Widget getSemesterContent(String semester,Size screenSize) {
    ...
    switch (semester) {
      ...
      case 'Semester 2':
        return Semester2();
      case 'Semester 3':
        return Semester3CSSE();
      case 'Semester 4':
        return Semester4CSSE();
      case 'Semester 5':
        return Semester5CSSE();
      case 'Semester 6':
        return Semester6CSSE();
      default:
        return Center(
          child: Padding(
