...
import '../ECS/Semester3ECS.dart';
import '../ECS/Semester4ECS.dart';
import '../ECS/Semester5ECS.dart';
import '../ECS/Semester6ECS.dart';
import '../Semester1.dart';
import '../Semester2.dart';
class ECSPage extends StatefulWidget {
  const ECSPage({super.key});
  @override
  State<ECSPage> createState() => ECSPageState();
}

class ECSPageState extends State<ECSPage> {
