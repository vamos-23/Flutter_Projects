...
class Semester4IT extends StatefulWidget {
  const Semester4IT({super.key});

  @override
  State<Semester4IT> createState() => _Semester4ITState();
}

class _Semester4ITState extends State<Semester4IT> {
  ...
  final credits = [3,3,4,2,3,3,1,1,1];
  double sgpa = 0.0;
