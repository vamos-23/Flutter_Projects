...
class Semester6EE extends StatefulWidget {
  const Semester6EE({super.key});

  @override
  State<Semester6EE> createState() => _Semester6EEState();
}

class _Semester6EEState extends State<Semester6EE> {
  var grades = ['Select Grade', 'O', 'E', 'A', 'B', 'C', 'D', 'F'];
  var subjects = [
    'Microprocessors & Embedded System',
    'Principles of Communication Engineering',
    'PSO Control and Protection',
  ...
  final credits = [3,3,4,3,3,3,1,1,1,2];
  double sgpa = 0.0;
