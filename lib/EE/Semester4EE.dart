...
class Semester4EE extends StatefulWidget {
  const Semester4EE({super.key});

  @override
  State<Semester4EE> createState() => _Semester4EEState();
}

class _Semester4EEState extends State<Semester4EE> {
  ...
  final credits = [3,4,3,3,3,2,1,1,1];
  double sgpa = 0.0;
