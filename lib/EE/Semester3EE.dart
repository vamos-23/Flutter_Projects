...
class Semester3EE extends StatefulWidget {
  const Semester3EE({super.key});

  @override
  State<Semester3EE> createState() => _Semester3EEState();
}

class _Semester3EEState extends State<Semester3EE> {
  ...
  var subjects = [
    ...
    'Analog & Digital Electronics Circuit',
    'Electric Circuit Lab',
    'Measurement & Sensor Lab',
    'Analog & Digital Circuit Design Lab',
    'Vocational Elective'
  ];
  List<String> selectedGrades = List.filled(10, ''); // List to store selected grades
  final credits = [4,3,4,2,3,3,1,1,1,1];
  double sgpa = 0.0;
